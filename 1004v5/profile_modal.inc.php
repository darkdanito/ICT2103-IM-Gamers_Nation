        	...
        	?>
      		<div class="modal-body"> 
          		<form role="form" method="post" action="checklogin.php">
          			...
          			<button type="Submit" name = "Submit2" class="btn btn-default" >
                    	Logout
                    </button>  
      				<button type="button" name = "changepasswordbutton" class="btn btn-danger" data-toggle="modal" data-target="#ResetPwModal">
                    	Change Password
                    </button>
      		</div>
          </form>
